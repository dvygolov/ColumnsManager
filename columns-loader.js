(function columnsmanagerLoader(config) {
  "use strict";

  const loaderConfig = Object.assign({
    app: "ColumnsManager",
    manifestUrl: "https://columnsmanager.pages.dev/columns/latest/manifest.html",
    embeddedManifest: null,
    cacheKey: "columnsmanager.loader.cache.v1",
    timeoutMs: 45000,
  }, config || {});
  const guardKey = "__ColumnsManagerLoader";
  ...
  const executePayload = (source, build) => new Promise((resolve, reject) => {
    const blob = new Blob([
      source,
      `\n//# sourceURL=columnsmanager://${build}/payload.js`,
